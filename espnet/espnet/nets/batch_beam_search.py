...
class BatchBeamSearch(BeamSearch):
    ...
    def search(
        ...
        for (
            ...
            scores_dict = {str(index.item()): value.item() for index, value in zip(topk_output.indices, topk_output.values)}
            ...
            # d_t = hs[full_prev_hyp_id].squeeze(0)
            # a_t = batch_a_t[full_prev_hyp_id].squeeze(0) if batch_a_t.dim()!=0 else batch_a_t[full_prev_hyp_id]
