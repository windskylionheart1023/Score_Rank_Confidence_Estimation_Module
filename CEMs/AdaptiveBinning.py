...
def AdaptiveBinning(infer_results, show_reliability_diagram = True):
	...
	print([abs(a - b) for a, b in zip(confidence, accuracy)])
	...
	if show_reliability_diagram:
		...
		plt.legend(['Accuracy','Overconfident','Underconfident'], fontsize=14, loc=2)
		plt.xlim(0, 1)
		plt.ylim(0, 1)
...
#         plt.legend(['Perfect Calibration', 'Accuracy', 'Overconfidence', 'Underconfidence'], fontsize=12, loc='upper left')
#         plt.xlim(0, 1)
#         plt.ylim(0, 1)
